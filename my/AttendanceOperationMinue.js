...
export default class AttendanceOperationMinue extends Component {
    OpBack() {
        this.props.navigation.goBack('AttendanceOperationMinue')
    }
    constructor(props) {
        super(props);
    ...
    _confirm() {
        ...
        if(this.state.checkedData==''){
            return toast.center('请选择要删除的员工！');
        }
        this.props.navigation.navigate('AttendanceSetting',{checkdata:this.state.checkedData,companyid:this.props.navigation.state.params.companyid})
    }
    //搜索员工
    _onChangeText = (t) => {
        if(!t) {
        ...
        return(
            <View style={[styles.container]}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.formHeader}>删除白名单</Text>
                </View>
