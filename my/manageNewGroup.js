...
export default class ManageNewGroup extends Component {
    OpBack() {
        this.props.navigation.goBack('ManageNewGroup');
    }
    constructor(props) {
        super(props);
        this.state = {
            ...
            signIn:'9:00',
            signOut:'18:00',
            weekChose:[false,true,true,true,true,true,false,],
            listView:[],
            handle:false,
            companyname:'',
            departData:[],
    ...
    save(){
        ...
        var url = config.api.base + config.api.getAttendanceData;
        request.post(url,{
        ...
        DeviceEventEmitter.emit('newgroup',this.props.navigation.state.params.companyid);
        this.props.navigation.goBack('ManageNewGroup');
    }
    add_listView(){
        ...
        return (
            <View style={styles.ancestorCon}>
                <View style={styles.container}>
                    ...
                    <Text style={styles.formHeader}>新建分组</Text>
